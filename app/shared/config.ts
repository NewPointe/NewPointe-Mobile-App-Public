...
export class Config {
    ...
    static get FeatureTileImage(): string {
        return getString("FeatureTileImage");
    }
    static set FeatureTileImage(skipLogin: string) {
        setString("FeatureTileImage", skipLogin);
    }
    static get FeatureTileUrl(): string {
        return getString("FeatureTileUrl");
    }
    static set FeatureTileUrl(skipLogin: string) {
        setString("FeatureTileUrl", skipLogin);
    }
